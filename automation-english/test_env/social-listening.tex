...
\toprule
Category Term & Definition & When to use & When not~to
use\tabularnewline
\midrule
\endhead
{[}Custom Tags - themes and categories{]} & & &\tabularnewline
{[}Community specific jargon{]} & & &\tabularnewline
Social Currency Dimensions: & & &\tabularnewline
...
who you are as a business and show they are onboard with
it.\tabularnewline
...
are onboard with it.\tabularnewline
...
were useful once, use utility instead.\tabularnewline
...
with and trust you as a loyal customer or community
member.\tabularnewline
INTERNAL REPUTATION 9 & Do people believe these things strongly enough
to warrant conversation or action? & &\tabularnewline
